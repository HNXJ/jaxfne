...
- **jaxfne-v0333-colab-gemini-evidence.ipynb** — Colab prototype; Gemini evidence collection (pre-release exploration)
- **jaxfne-v0333-colab-gemini-orientation.ipynb** — Colab prototype; Gemini orientation task (pre-release exploration)
- **jaxfne-v0333-colab-gemini-task-smoke.ipynb** — Colab prototype; Gemini task smoke test (pre-release exploration)
