...
The current published **PyPI** release is **`jaxfne==0.4.24`** (tag `v0.4.24`),
published from the artifacts built and validated for commit `7f89eff`. The
previous release is **`0.4.23`** (tag `v0.4.23`). The current **development**
