...
| **Fig 2** | Source/field contracts and truth gates | `scripts/publication/fig02_contracts.py` **(implemented)** | `figures/publication/fig02_source_field_contracts.png`, `outputs/publication/fig02_source_field_contracts_manifest.json` | `python scripts/publication/fig02_contracts.py` + SHA256 manifest | no PDE solve claim |
| **Fig 3** | jaxfne backend: Config→Net→simulate | `scripts/publication/fig03_backend.py` **(implemented)** | `figures/publication/fig03_jaxfne_backend.png`, `outputs/publication/fig03_jaxfne_backend_manifest.json` | `python scripts/publication/fig03_backend.py` + SHA256 manifest | package-native API only |
...
| **Fig 8** | Adjacent tools comparison (positioning) | `scripts/publication/fig08_adjacent_tools_comparison.py` **(implemented)** | `figures/publication/fig08_adjacent_tools_comparison.png`, `outputs/publication/fig08_adjacent_tools_comparison_manifest.json` | `python scripts/publication/fig08_adjacent_tools_comparison.py` + SHA256 manifest | compare capabilities, not superiority |
...
| Figures | complete (8/8 main) | 10 Extended Data PNG assets remaining (see inventory) | `python scripts/publication/fig08_adjacent_tools_comparison.py` | inventory reports `8/8` main figures |
...
python scripts/publication/fig02_contracts.py
python scripts/publication/fig03_backend.py
