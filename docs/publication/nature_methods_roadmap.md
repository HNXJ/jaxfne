...
| Figures | partial (4/8 main) | 14 PNG assets remaining (see inventory) | `python scripts/publication/fig04_minimal_install_run.py` | inventory reports `4/8` main figures |
