...
- **Measured performance (Relative error envelope at the tested grid) {Q02, Q03, Q04, Q05, Q06, Q07}:** ε_f = 0 across cases; ε_k̂ ≤ 0.00831 (relative), ε_θ = 0, ε_v ≤ 0.00824; the only sensitivity loss appears at amplitude A = 0.05 with σ = 0.5 (2/40 cases in the A-2 S1 grid below). A-1a validates the estimator in isolation; the dynamical question of whether the network generates waves is A-1b.
