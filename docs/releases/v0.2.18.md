...
This release does not introduce a Poisson solver implementation, new public APIs, calibrated physical-amplitude statuss, or biological validation statements. It establishes a durable contract layer and documentation foundation for future solver implementation and validation work.
...
* No biological validation statements.
