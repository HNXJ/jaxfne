...
jaxfne v0.3.4 marks the stable v0.3 tutorial-scenario release. The chainable Configuration grammar runs and round-trips correctly end-to-end, and the core tutorials execute with proper optional dependency handling.

**Key theme:** v0.3.4 is "tutorial-scenario spine with a stable public grammar."
...
Three v0.3.x core tutorials execute end-to-end and produce finite, schema-valid output:
