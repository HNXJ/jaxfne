...
readouts = model.compute_readout(signals, [
    ...
    jtfne.readout_spec("voltage_mean", "mean_V_m"),
])
...
All diagnostics keep `amplitude_status: false`. Physical amplitude claims require separate calibration and validation evidence.
...
Dark-theme Plotly panels from the single-neuron example's scale (100 ms, dt 0.1 ms, seed 0): [index](../_static/atlas/single_neuron/index.html) · [schema](../_static/atlas/single_neuron/schema.html) · [3D](../_static/atlas/single_neuron/network_3d.html) · [raster](../_static/atlas/single_neuron/raster.html) · [LFP](../_static/atlas/single_neuron/lfp.html) · [H](../_static/atlas/single_neuron/h_dynamics.html) · [HDP](../_static/atlas/single_neuron/hdp.html) · [oscillatory](../_static/atlas/single_neuron/oscillatory.html).
