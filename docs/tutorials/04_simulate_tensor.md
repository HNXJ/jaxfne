...
Dark-theme Plotly panels from the pinned 200 ms reference run of this same canonical column (the page runs 1000 ms; the atlas is the shorter pinned run): [index](../_static/atlas/index.html) · [3D](../_static/atlas/network_3d.html) · [connectivity](../_static/atlas/connectivity.html) · [raster](../_static/atlas/raster.html) · [traces](../_static/atlas/traces.html) · [spectral](../_static/atlas/spectral.html) · [state summary](../_static/atlas/state_summary.html).
