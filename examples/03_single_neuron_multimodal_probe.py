...
Generates:
    ...
    ├── validation_report.json       (status metadata verification)
...
def main():
    ...
    validation_report = {
        ...
        # Legacy alias: claim_level → model_status
        "claim_level": manifest.get("claim_level", tutorial_runtime.manifest_model_status(manifest)),
        ...
        "field_claim_level": manifest.get(
            "field_claim_level", tutorial_runtime.manifest_field_model_status(manifest)
        ),
        ...
        "physical_amplitude_calibrated": manifest.get(
            ...
            tutorial_runtime.manifest_amplitude_status(manifest),
        ),
    ...
    # === 9. Write outputs ===
    output_dir = tutorial_runtime.out_dir("v023_single_neuron_multimodal")
