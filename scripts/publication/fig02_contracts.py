...
FIGURE_PATH = REPO_ROOT / "figures" / "publication" / "fig02_source_field_contracts.png"
MANIFEST_PATH = REPO_ROOT / "outputs" / "publication" / "fig02_source_field_contracts_manifest.json"
SOURCE_FILES = [
