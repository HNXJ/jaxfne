...
| 7 | 0.4.7 | 80 | 78 | in_progress | Majority of the unreviewed backlog reviewed and either fixed or explicitly cleared with evidence (not silently skipped). |
| 8 | 0.4.7 | 95 | 86 | in_progress | Full external-facing polish: every active tutorial/notebook verified to actually run (not just hygiene-lint clean) again |
