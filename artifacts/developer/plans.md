...
| test-strategy-consolidate-to-etudes-suites | [SCOPING NEEDED, DO NOT START] Redirect test coverage: retire redundant unit tests, grow etude/suite notebooks to cover  | scoped | tests/; tutorials/etudes/; scripts/*suite*.py |
