...
- 23-VERIFY-01 — IN PROGRESS: dev green; broad 3834/3835 (1 environmental); slow/notebook/docs/examples/build/twine/wheel-smoke green; blocked on human picks (HDP-02 re-baseline, manifest workspace decision); full RC seal + publish chain needs authorization
