...
| `jaxfne-developer` | bounded doc/viz/release execution from `artifacts/todo_stack.md` batches | scientific reinterpretation, API/release decisions, commit/push/tag |
