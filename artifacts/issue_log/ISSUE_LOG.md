...
| P-009 | FIXED (human decision 2026-09-24: warmup). Both sim and projection warmed and blocked before timing; old test compared JIT compile times. Steady state: sim ~0.02s vs projection ~3.6ms, 5/5 PASS | `tests/test_field01_audit.py` |
