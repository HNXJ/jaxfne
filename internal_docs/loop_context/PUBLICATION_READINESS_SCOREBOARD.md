...
Last updated: after ED7 on `pub/ed05-manifest-hashes`.
...
| Inventory | 8/8 main figures; 6/10 Extended Data after ED7 |
| Main figures | complete (fig01–fig08) |
| Extended Data | ED1–ED5, ED7 complete; ED6, ED8–ED10 pending |
| Next planned ED | ED6 benchmark scaling tables (`ed06_benchmark_scaling_tables`) |
...
| 3 | Extended Data stack | 55 | 100 | 10/10 ED panels + receipts | ED6, ED8–ED10 | inventory 10/10 ED |
...
| 11 | probe/readout contracts | 78 | 95 | eight families, finite outputs, status labels | ED7 done; keep regression with probe tests | all probe rows finite + gates false |
...
**Global estimate (scaffold/software-methods):** ~74/100 after ED7.
