"""Evidence-figure manifest helpers (truth gates, strict JSON, SHA receipts).

Used by ``scripts/evidence_figures/`` generators. Matplotlib export lives in
``evidence_export.py`` (``jaxfne.vis`` grammar).
"""
